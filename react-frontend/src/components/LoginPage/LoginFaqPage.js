      ...
      <div className="flex-1 flex items-center mt-[100px] md:mt-0 flex-col md:flex-row mx-auto w-full max-w-[1200px] gap-7 px-7">
        ...
        <div className="flex-1">
          ...
          >
            ...
            {/* New FAQs - Login & Signup Related */}
            <AccordionTab
              header={
                <div className="flex justify-between">
                  <h3 className="mb-0 text-xl font-semibold !text-secondary">
                    Can I sign in with my Staff ID instead of email?
                  </h3>
                  <i
                    className={classNames(
                      "pi pi-chevron-down duration-300",
            ...
            <AccordionTab
              header={
                <div className="flex justify-between">
                  <h3 className="mb-0 text-xl font-semibold !text-secondary">
                    How do I sign up with a Staff ID?
                  </h3>
                  <i
                    className={classNames(
                      "pi pi-chevron-down duration-300",
            ...
            <AccordionTab
              header={
                <div className="flex justify-between">
                  <h3 className="mb-0 text-xl font-semibold !text-secondary">
                    What if I enter an invalid email during signup?
                  </h3>
                  <i
                    className={classNames(
                      "pi pi-chevron-down duration-300",
            ...
            >
              <p>
                If you are signing up with email, you must provide a valid
                email. If you enter an invalid email, you will receive an error
                message, and you will not be able to proceed to the next step
                until you enter a valid email.
              </p>
            </AccordionTab>
